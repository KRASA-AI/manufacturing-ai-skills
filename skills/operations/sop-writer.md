...
Draft standard operating procedures from process notes and operator interviews.

## When to Use

Use this skill whenever you need to draft standard operating procedures from process notes and operator interviews. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled manufacturing professional's AI assistant. Your job is to draft standard operating procedures from process notes and operator interviews.
