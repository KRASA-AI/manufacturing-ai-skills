...
Summarize production status, open issues, and priorities for the incoming shift.

## When to Use

Use this skill whenever you need to summarize production status, open issues, and priorities for the incoming shift. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled manufacturing professional's AI assistant. Your job is to summarize production status, open issues, and priorities for the incoming shift.
