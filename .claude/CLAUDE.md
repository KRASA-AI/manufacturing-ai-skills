...
You are working inside the **Manufacturing AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for manufacturers. It contains:
...
- Industry page: https://krasa.ai/industries/manufacturing
